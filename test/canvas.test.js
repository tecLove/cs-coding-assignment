...
describe("Commands", () => {
  ...
  describe("createCanvas", () => {
    it("should not allow canvas smaller than 1 x 1", () => {
      expect(createCanvas.bind(null, 0, 0)).to.throw("Invalid dimension");
    });

    it("should create a 20 x 4 canvas", () => {
      const expected = [
        [
          " ",
          " ",
  ...
  describe("drawLine", () => {
    ...
    it("should not allow drawing lines that extend out of the canvas.", () => {
      expect(drawLine.bind(null, canvas, 1, 2, 30, 2)).to.throw(
        "Draw inside the canvas."
      );
      expect(drawLine.bind(null, canvas, 1, 1, 1, 10)).to.throw(
        "Draw inside the canvas."
      );
    });

    it("should not allow diagonal lines.", () => {
      expect(drawLine.bind(null, canvas, 1, 1, 4, 4)).to.throw(
        "Only vertical or horizontal lines are supported."
      );
    });
  });
  ...
  describe("drawRectangle", () => {
    ...
    it("should not allow rectangles that extend out of the canvas.", () => {
      expect(drawRectangle.bind(null, canvas, 14, 1, 30, 3)).to.throw(
        "Draw inside the canvas."
      );
      expect(drawRectangle.bind(null, canvas, 14, 1, 18, 10)).to.throw(
        "Draw inside the canvas."
      );
    });
  });
  ...
  describe("drawHorizontalLine", () => {
    it("should generate an array of dashes equal to the length passed plus one on each end.", () => {
      const border = drawHorizontalLine(4);
      const expected = ["-", "-", "-", "-", "-", "-"];
  ...
  describe("drawCanvas", () => {
    it("should render the canvas with the given cells and surrounded by borders.", () => {
      const rendered = drawCanvas(canvas);
      const expected =
        "----------------------\n" +
        "|                    |\n" +
        "|                    |\n" +
    ...
    it("should render the canvas with drawings.", () => {
      ...
      const rendered = drawCanvas(canvasWithDrawings);
      const expected =
        "----------------------\n" +
        "|             xxxxx  |\n" +
        "|xxxxxx       x   x  |\n" +
    ...
    it("should render the canvas with drawings and filled area.", () => {
      ...
      const filled = fillArea(canvasWithDrawings, 10, 3, "o");
      const rendered = drawCanvas(filled);
      const expected =
        "----------------------\n" +
